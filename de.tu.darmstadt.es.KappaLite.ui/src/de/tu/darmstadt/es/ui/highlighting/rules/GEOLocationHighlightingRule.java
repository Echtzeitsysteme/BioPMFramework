...
import de.tu.darmstadt.es.kappaLite.KLIGeoLocation;
...
public class GEOLocationHighlightingRule extends AbstractHighlightingRule {
	...
	protected boolean getHighlightingConditions(EObject moslObject, INode node) {
		if(moslObject instanceof KLIGeoLocation) {
			return node.getText().equals(KLIGeoLocation.class.cast(moslObject).getName());
		}
		return false;
	}
